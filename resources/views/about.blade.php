<x-layout title="About Us">
	...
	<section class="py-16 sm:py-24 bg-white border-b border-neutral-200/60">
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="max-w-3xl">
				<span class="text-xs font-bold text-[#45b7be] uppercase tracking-wider">Our Mission</span>
	...
	<section class="py-16 sm:py-20">
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="grid grid-cols-2 gap-8 md:grid-cols-4">
				<!-- Stat 1 -->
				<div class="border-l-2 border-[#45b7be] pl-4">
	...
	<section class="bg-white py-16 sm:py-24 border-t border-b border-neutral-200/60">
		...
		<div class="mt-12 grid grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
			...
			<div class="overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-100 aspect-square">
				<img src="{{ asset('images/team-02.png') }}" alt="Sarah Jenkins" class="h-full w-full object-cover">
			</div>
			<div>
				<h3 class="text-base font-bold text-neutral-950 tracking-tight">Sarah Jenkins</h3>
				<p class="text-xs font-semibold text-[#45b7be] uppercase tracking-wide">Founder / Principal Architect</p>
			</div>
			</div>
			...
			<div class="space-y-4">
			<div class="overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-100 aspect-square">
				<img src="{{ asset('images/team-01.png') }}" alt="Marcus Chen" class="h-full w-full object-cover">
			</div>
			<div>
				<h3 class="text-base font-bold text-neutral-950 tracking-tight">Timothy Samuel</h3>
				<p class="text-xs font-semibold text-[#45b7be] uppercase tracking-wide">Head of Engineering</p>
			</div>
			</div>
			...
			<div class="space-y-4">
			<div class="overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-100 aspect-square">
				<img src="{{ asset('images/team-04.png') }}" alt="Elena Rostova" class="h-full w-full object-cover">
			</div>
			<div>
				<h3 class="text-base font-bold text-neutral-950 tracking-tight">Elena Rostova</h3>
				<p class="text-xs font-semibold text-[#45b7be] uppercase tracking-wide">Lead Product Designer</p>
			</div>
			</div>
			...
			<div class="space-y-4">
			<div class="overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-100 aspect-square">
				<img src="{{ asset('images/team-03.png') }}" alt="David Kim" class="h-full w-full object-cover">
			</div>
			<div>
				<h3 class="text-base font-bold text-neutral-950 tracking-tight">David Kim</h3>
				<p class="text-xs font-semibold text-[#45b7be] uppercase tracking-wide">Core Ecosystem Relations</p>
			</div>
			</div>
